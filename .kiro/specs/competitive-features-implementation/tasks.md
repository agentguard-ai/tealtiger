...
**Subtasks:**
- [ ] 1.1 Create Guardrail interface with evaluate, configure methods
- [ ] 1.2 Implement GuardrailEngine with parallel execution support
- [ ] 1.3 Add guardrail registry for dynamic registration
- [ ] 1.4 Implement guardrail caching mechanism
- [ ] 1.5 Add error handling for individual guardrail failures
- [ ] 1.6 Write unit tests for guardrail engine
...
**Subtasks:**
- [ ] 2.1 Implement PIIDetectionGuardrail with pattern matching
- [ ] 2.2 Implement ContentModerationGuardrail with OpenAI Moderation API
- [ ] 2.3 Implement PromptInjectionGuardrail with pattern detection
- [ ] 2.4 Add configurable actions (block, redact, mask) for each guardrail
- [ ] 2.5 Write unit tests for each guardrail
- [ ] 2.6 Add integration tests for guardrail combinations
...
**Subtasks:**
- [ ] 3.1 Create CostTracker class with pricing data
- [ ] 3.2 Implement estimateCost method for pre-execution estimation
- [ ] 3.3 Implement calculateActualCost method for post-execution tracking
- [ ] 3.4 Add CostStorage for persisting cost records
- [ ] 3.5 Implement budget checking and alert system
- [ ] 3.6 Add budget enforcement with automatic blocking
- [ ] 3.7 Write unit tests for cost calculations
...
**Subtasks:**
- [ ] 4.1 Create GuardedOpenAI class extending OpenAI
- [ ] 4.2 Implement chat.completions.create with security evaluation
- [ ] 4.3 Add cost tracking integration
- [ ] 4.4 Add security metadata to responses
- [ ] 4.5 Implement error handling with AgentGuardError
- [ ] 4.6 Write unit tests for API compatibility
...
**Subtasks:**
- [ ] 5.1 Create GuardedAnthropic class extending Anthropic
- [ ] 5.2 Implement messages.create with security evaluation
- [ ] 5.3 Add cost tracking for Claude models
- [ ] 5.4 Add security metadata to responses
- [ ] 5.5 Write unit tests for API compatibility
...
**Subtasks:**
- [ ] 6.1 Create GuardedAzureOpenAI class extending AzureOpenAI
- [ ] 6.2 Implement chat.completions.create with security evaluation
- [ ] 6.3 Add cost tracking for Azure pricing
- [ ] 6.4 Handle Azure-specific authentication
- [ ] 6.5 Write unit tests for API compatibility
